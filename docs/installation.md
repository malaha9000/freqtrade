# Install the bot
This page explains how to prepare your environment before running the
bot. To understand how to setup the bot please read the 
...
3. Go into the new directory: `cd freqtrade`
4. Copy config.sample `cp config.json.example config.json`
To edit the config please refer to [Bot Configuration](https://github.com/gcarq/freqtrade/blob/develop/docs/configuration.md) 
5. Create your DB file `touch tradesv3.sqlite` (Prod mode) or `touch tradesv3.dryrun.sqlite` (Dry-run mode)
...
and will be lost when you will refresh your image. This s
...
## 6. Run the bot
If this is the first time your run the bot ensure your are running it
